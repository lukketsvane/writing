...
image: public/images/what-is-generative-art/bw_simple_1.png
---
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/bw_simple_1.png" alt="Generative Art Example 1" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/bw_simple_2.png" alt="Generative Art Example 2" style={{ width: '100%' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/bw_simple_1.png" alt="bw_simple_1" style={{ width: '100%', marginBottom: '10px' }} />
    <img src="public/images/what-is-generative-art/bw_simple_2.png" alt="bw_simple_2" style={{ width: '100%' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/bw_simple_3.png" alt="bw_simple_3" style={{ width: '100%', marginBottom: '10px' }} />
    <img src="public/images/what-is-generative-art/bw_simple_4.png" alt="bw_simple_4" style={{ width: '100%' }} />
  </div>
</div>
...
![Vera Molnar's Work](public/images/what-is-generative-art/vera_molnar_interruptions.webp)
...
![func_ran.png](public/images/what-is-generative-art/func_ran.png)
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/thunderstorm.png" alt="Thunderstorm" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/lava_lamp.png" alt="Lava Lamp" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/distribution%20sketch.png" alt="Distribution Sketch" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/func_spatter.png" alt="Function Spatter" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/func_3.png" alt="Random Distribution" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/func_4.png" alt="Perlin Noise Distribution" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/sol_lewitt_wall_drawing.png" alt="Sol LeWitt - Wall Drawing #118" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Sol LeWitt - Wall Drawing #118</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/sol_lewitt_proposal_for_wall_drawing.png" alt="Sol LeWitt - Proposal for Wall Drawing" style={{ width: '100%', marginBottom: '10px' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '33.33%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/sol_lewitt_Interactive_wall_drawing.png" alt="Genuary Day 7 - Sol LeWitt Wall Drawing" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Genuary Day 7 - Sol LeWitt Wall Drawing</p>
  </div>
  <div style={{ width: '33.33%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/sol_lewitt_wall_drawing_interactive.jpg" alt="Interactive Sol LeWitt Wall Drawing" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Interactive Sol LeWitt Wall Drawing</p>
  </div>
  <div style={{ width: '33.33%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/sol_lewitt_drawing_being_made_at_dia_beacon.png" alt="Sol LeWitt drawing being made at Dia Beacon" style={{ width: '100%', marginBottom: '10px' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
  <div style={{ width: '30%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/conway_1.gif" alt="3 phase pulsar" style={{ width: '100%' }} />
    <p>3 phase pulsar</p>
  </div>
  <div style={{ width: '30%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/conway_2.gif" alt="Finite pattern" style={{ width: '100%' }} />
    <p>Finite pattern</p>
  </div>
  <div style={{ width: '30%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/conway_3.gif" alt="Gliders" style={{ width: '100%' }} />
    <p>Gliders</p>
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/snowflake_1.png" alt="Snowflake 1" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/snowflake_2.png" alt="Snowflake 2" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/magical_contamination_1.png" alt="Magical Contamination 1" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/magical_contamination_2.png" alt="Magical Contamination 2" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/reas_rgb_3_1.jpg" alt="Casey Reas RGB 3 1" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/reas_rgb_3_2.jpg" alt="Casey Reas RGB 3 2" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/flight_patterns.jpg" alt="Flight Patterns (2010) - Aaron Koblin" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Flight Patterns (2010) - Aaron Koblin</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/asphyxia.jpg" alt="Asphyxia (2015) - Maria Takeuchi , Frederico Phillips, performed by Shiho Tanaka" style={{ width: '100%', marginBottom: '10px' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/charles_sowers_windswept_1.png" alt="Windswept (2011) - Charles Sowers" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Windswept (2011) - Charles Sowers</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/charles_sowers_windswept_2.png" alt="Windswept (2011) - Charles Sowers" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Windswept (2011) - Charles Sowers</p>
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/myriad_tulips.jpg" alt="Myriad (Tulips) (2018) - Anna Ridler" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Myriad (Tulips) (2018) - Anna Ridler</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/mosaic_virus.jpg" alt="Mosaic Virus (2019) - Anna Ridler" style={{ width: '100%', marginBottom: '10px' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/hilma_af_klint_the_five.png" alt="A collective automatic drawing by The Five, Hilma af Klint's spiritualist group" style={{ width: '100%', marginBottom: '10px' }} />
    <p>A collective automatic drawing by The Five, Hilma af Klint's spiritualist group</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/the_smile_of_the_flamboyant_wings.png" alt="The Smile of the Flamboyant Wings (1953) - Joan Miró" style={{ width: '100%', marginBottom: '10px' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/paul_emile_borduas_untitled.webp" alt="Untitled (1954-55) - Paul Emile Borduas" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Untitled (1954-55) - Paul Emile Borduas</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/max_ernst_forest_and_dove.jpg" alt="Forest and Dove (1927) - Max Ernst Uses grattage technique" style={{ width: '100%', marginBottom: '10px' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
  <div style={{ width: '80%', padding: '5px' }}>
    <img src="public/images/what-is-generative-art/jackson_pollock_alchemy.png" alt="Alchemy (1947) - Jackson Pollock" style={{ width: '100%', marginBottom: '10px' }} />
